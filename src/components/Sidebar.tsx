...
const Sidebar = () => {
  ...
  return (
    <section className="w-full max-w-32 bg-[#0e1323] py-10 px-10 flex flex-col gap-10">
      <div className="text-5xl font-bold text-white text-center">J</div>
      <div className="flex flex-col gap-4 items-center justify-center">
        {icons.map((Icon) => (
          <div className={"px-8 py-3 rounded-2xl cursor-pointer"}>
            <Icon stroke="white" />
          </div>
        ))}
      </div>
